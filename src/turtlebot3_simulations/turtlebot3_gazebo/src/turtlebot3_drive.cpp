...
#include <random> // Include this at the beginning of your file
...
double add_gaussian_noise(double data, double mu = 0.0, double sigma = 0.05)
{
...
void Turtlebot3Drive::odomMsgCallBack(const nav_msgs::Odometry::ConstPtr &msg)
{
  ...
  // Gaussian noise
  tb3_pose_ = add_gaussian_noise(atan2(siny, cosy));
  ROS_INFO("TurtleBot3 Pose With Noise: %f", tb3_pose_);
}
